							...
							<div class="col-lg-12 pr-0">
								<ul class="nav navbar-nav center_nav pull-right">
									...
									<li class="nav-item submenu dropdown">
										<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Doctor</a>
										<ul class="dropdown-menu">
											<li class="nav-item">
												<a class="nav-link" href="<%=OPSView.DOCTOR_CTL%>">Add Doctor</a>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="<%=OPSView.DOCTOR_LIST_CTL%>">Doctor List</a>
											</li>
										</ul>
									</li>
									...
									<li class="nav-item ">
										<a class="nav-link" href="<%=OPSView.BOOK_MEDICINE_LIST_CTL%>">Book Medicine List</a>
									</li>
									...
									<li class="nav-item submenu dropdown">
										<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Consult Medicine</a>
										<ul class="dropdown-menu">
											<li class="nav-item">
												<a class="nav-link" href="<%=OPSView.CONSULT_CTL%>">Consult</a>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="<%=OPSView.CONSULT_LIST_CTL%>">Consult Report</a>
											</li>
										</ul>
									</li>
									...
									<li class="nav-item ">
										<a class="nav-link" href="<%=OPSView.USER_REGISTRATION_CTL%>">SignUp</a>
									</li>
